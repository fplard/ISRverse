...
#'
#' @examples
Sur_ana <- function(Data, DeathInformation, CalculateMetricsFrom = c("Raw", "Kaplan-Meier", "Model"), 
                    Models = "GO", Shape = "simple", 
...
dir.create(PlotDir)
  ...
  expect_named(out, c("summary","metrics",  "bastaRes", "DICmods", "check", 'relex_from0', 'Sur5', 'Sur1', 'Sur1m'))
