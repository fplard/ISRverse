      ...
      if(nrow(sexDat$data)>0){
        ...
        if(nrow(data_sel)>0){
          ...
          if ("sur" %in% Sections) {
            ...
            repout$surv[[sx]] <- Sur_main(DataCore = sexDat$data,  
...
test_that("tx_report works", {
  ...
  expect_named(out$sur$Male$from0, c('summary', 'metrics', 'bastaRes', 'DICmods', 'KM_estimator', 'bastatab', 'relex', 'Sur1', 'Sur5', 'L90', 'L50', 'check', 'relex_from0', 'Sur1m'))
...
* `SpeciesNamefun` latin name of the selected species
