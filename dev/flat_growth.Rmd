...
* `sexCats`: Male, Female and/or All
* `BirthTypebysex`: When separated the analysis by sex category, the birth type to be selected: Captive, Wild, or All
* `BirthType`: Captive and/or Wild Default =  NULL
* `sexCatsbyBT`: When separated the analysis by birth typ, the sex to be selected: Male, Female, or All
* `agemat`: A list including the age at sexual maturity for each sex selected in `SexCats` and in `sexCatsbyBT`.
...
* `sex`: Male, Female or All Default =  "All"
...
# data(weights_chev)
# weights = Gro_remoutliers(weights_chev, taxa = "Mammalia", ageMat =1, IQR = 2.75, minq=0.025,variableid ="AnonID")
```
...
* data_weight including at least the numeric columns *Age*, *MeasurementValue* and *anonID* 
...
* data including at least the numeric columns *Age*, *MeasurementValue* and *anonID* 
